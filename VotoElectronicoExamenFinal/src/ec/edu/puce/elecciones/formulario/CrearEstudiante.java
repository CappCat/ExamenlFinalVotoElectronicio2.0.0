...
public class CrearEstudiante extends JInternalFrame implements ActionListener {
	...
	public CrearEstudiante(List<Curso> cursos, List<Estudiante> estudiantes, int idEstudiante) {
		...
		txtNombre.setBounds(99, 69, 231, 19);
		getContentPane().add(txtNombre);
		txtNombre.setColumns(10);

		btnNuevo = new JButton("Nuevo");
		btnNuevo.addActionListener(this);
		btnNuevo.setBounds(30, 111, 117, 25);
		getContentPane().add(btnNuevo);

		btnGuardar = new JButton("Agregar");
		btnGuardar.addActionListener(this);
		btnGuardar.setBounds(157, 111, 117, 25);
		getContentPane().add(btnGuardar);

		btnCancelar = new JButton("Cancelar");
		btnCancelar.addActionListener(this);
		btnCancelar.setBounds(284, 111, 117, 25);
		getContentPane().add(btnCancelar);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(12, 147, 416, 192);
		...
		lblNombres_1.setBounds(30, 72, 70, 15);
		...
		txtCedula.setBounds(99, 42, 231, 19);
		getContentPane().add(txtCedula);
		
		JLabel lblCedula = new JLabel("Cédula");
		lblCedula.setBounds(30, 42, 70, 15);
	...
	private void agregarEstudiante() {
		...
		estudiante.setClavePersonal((int)(Math.random()*100000)+"");
